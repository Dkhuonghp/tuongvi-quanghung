                    ...
                    >
                        ...
                        >
                            ...
                            <h5
                                ...
                                className="font-questrial mt-1 vs-attendance-name-text"
                            >
                                Chung vui cùng gia đình chúng tôi mừng lễ vu quy
                            </h5>
                        </div>
                        <div
                            id="i9lsh9"
                        ...
                        >
                            ...
                            >
                                KHU DÂN CƯ HIM LAM (SỐ 379, ĐƯỜNG SỐ 1)
                            </h5>
                            <div className="btn-box">
                                <a
                                    href="https://maps.app.goo.gl/iMZchM1FSWHWXeXb9?g_st=ipc"
                                    target="_blank"
                            ...
                            >
                                Sự hiện diện của Quý khách là niềm vinh hạnh của
                                gia đình chúng tôi!
                            </h5>
                        </div>
                    </div>
